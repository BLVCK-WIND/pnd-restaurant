...
@section('title', 'Thêm Option Group')
...
<div class="max-w-2xl">
    ...
    <div class="flex items-center gap-3 mb-6">
        ...
        <h1 class="text-2xl font-bold text-gray-800">Thêm Option Group</h1>
    </div>

    <div class="bg-white rounded-2xl shadow p-6">
        <form action="{{ route('admin.optiongroups.store') }}" method="POST"
              class="space-y-5">
            @csrf
            @include('admin.optiongroups._form')
